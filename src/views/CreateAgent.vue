<template>
    <div class="flex jc-c">
        <div class="section-wrapper page-top flex-1 relative">
    ...
    <div class="flex flex-1 jc-c overflow-y-scroll">
        <div class="section-wrapper flex-1">
            <div class="flex gap-32" :class="device === 'mobile' ? tab : ''">
                <div class="editor-container flex-1 pd-t-32">
                        ...
                        <div class="form-wrapper flex flex-column gap-8">
                            <div class="form-row flex flex-column gap-4">
                                <div class="input-wrapper flex flex-column gap-4">
                                    ...
                                    <input id="name" name="name" class="form-control" type="text" @input="markUnsaved" maxlength="20" placeholder="E.g. Cocoa farmer" autocomplete="off">
                ...
                <div class="preview-container flex flex-1 pd-t-32 flex-column sticky-top sticky">
                    <p><strong>Preview</strong></p>
                    <div class="preview-wrapper centered bg-surface-2 flex-1 br-12">
                        <span>Preview</span>
                    </div>
                </div>
            </div>
    ...
    <div class="flex jc-c">
        <div class="section-wrapper flex-1 relative" style="padding-bottom: 20px; padding-top: 16px;">
...
export default {
    ...
    methods: {
        ...
        goBack() {
            this.$router.push({ name: 'PublicProfile', params: { user: this.user.username }})
        },
        switchTab(tabName) {
            this.tab = tabName
        },
