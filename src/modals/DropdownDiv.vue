<template>
    <div class="dropdown fixed" :style="{ top: dropdown.top + 30 + 'px', left: dropdown.left + 'px'}">
        <ul>
            <a v-if="isOwner" @click.prevent="$emit('trigger-edit-mode')" href="#" class="flex ai-c gap-10">
            ...
            <a v-if="like && !isOwner" @click.prevent="$emit('add-to-favourite')" href="#" class="flex ai-c gap-10">
                <svg viewBox="0 0 12.464 11">
                    <path d="M10.768,4A3.519,3.519,0,0,1,13.256,10L8.411,14.85a.5.5,0,0,1-.712,0L2.854,10A3.519,3.519,0,1,1,7.83,5.028l.225.225.225-.225A3.5,3.5,0,0,1,10.768,4ZM8.055,13.782l4.49-4.49A2.512,2.512,0,1,0,8.992,5.74l-.581.581a.5.5,0,0,1-.712,0L7.118,5.74A2.512,2.512,0,1,0,3.565,9.293Z" transform="translate(-1.823 -3.997)"/>
                </svg>
                {{ isFavourite ? 'Remove from favourites' : 'Add to favourites' }}
            </a>
            <a href="#" @click.prevent="$emit('share')" class="flex ai-c gap-10">
            ...
            <a v-if="isOwner" href="#" class="flex ai-c delete gap-10" @click.prevent="$emit('delete-chat')">
