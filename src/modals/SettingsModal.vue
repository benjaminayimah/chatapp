                        ...
                        <li>
                            <a @click.prevent="handleRoute('preferences')" href="#" class="w-100 gap-8 flex ai-c bg-transition" :class="{'active-nav' : $route.query.page === 'preferences' }">
                                <svg viewBox="0 0 15.5 15.5">
                                    <path d="M-1982.25,15.5A7.759,7.759,0,0,1-1990,7.75,7.759,7.759,0,0,1-1982.25,0a7.759,7.759,0,0,1,7.75,7.75A7.759,7.759,0,0,1-1982.25,15.5Zm.25-14V13.994a6.214,6.214,0,0,0,4.251-1.908A6.221,6.221,0,0,0-1976,7.75a6.221,6.221,0,0,0-1.749-4.336A6.219,6.219,0,0,0-1982,1.5Z" transform="translate(1990)"/>
                                </svg>
                                Preferences
                            </a>
                        </li>
