<template>
    <div class="sticky ads-bar">
        <div class="flex jc-sb gap-4 ai-c ad-inner">
            ...
            <button-close
                :classes="'ai-c jc-c ad-close-btn'"
                :height="30"
                @handle-close-event="dismissAd"
            />
        </div>
...
export default {
    components: { ButtonSubmit, ButtonClose },
    methods: {
        dismissAd() {
            this.$store.commit('dismissAd')
        }
    }
}
</script>
...
.ads-bar {
    ...
    background: linear-gradient(150deg, #0085ff,#BA62FC,#F2416B);
}
.ad-inner {
    color: #fff;
    padding: 5px 8px;
