                ...
                <div v-if="!computedCurrentPrompt && chat.parts[0].text" :id="`response_footer_${index}`" class="flex gap-4 res-footer">
                    <div class="cluster-button-wrapper flex ai-c ov-hidden" :class="computedIsSpeaking ? 'is-speaking' : 'not-speaking'">
                        <button v-if="!computedIsSpeaking || computedIsPaused" 
                                @click="speakText()" 
                                class="transparent-button res-footer-btn" 
                        ...
                        <button v-if="computedIsSpeaking && !computedIsPaused" @click="pauseSpeech()" class="transparent-button res-footer-btn" aria-label="Read aloud">
                        ...
                        <button v-if="computedIsSpeaking || computedIsPaused" @click="stopSpeech()" class="transparent-button res-footer-btn" aria-label="Read aloud">
                            <svg height="17" viewBox="0 0 14 14">
                    ...
                    <button @click="copyResponse()" class="transparent-button res-footer-btn" aria-label="Copy" :disabled="isCopying">
                    ...
                    <button class="transparent-button res-footer-btn" aria-label="Share">
