    ...
    <div v-if="error" class="error-snack-container bg-modal-surface">
      <div class="flex ai-c gap-10">
        <svg height="18" viewBox="0 0 30 30">
            <path class="invert-fill-color" d="M16.5,22.5h3v3h-3Zm0-12h3v9h-3ZM17.985,3A15,15,0,1,0,33,18,14.993,14.993,0,0,0,17.985,3ZM18,30A12,12,0,1,1,30,18,12,12,0,0,1,18,30Z" transform="translate(-3 -3)" fill="#f22121"/>
        </svg>
        <span>{{ error }}</span>
        <button @click="$store.commit('dismissError')" class="transparent-button jc-c ai-c flex-shrink-0" data-type="modal">
