    ...
    <div class="chat-container bg-surface-2">
        <div v-if="form.image" class="image-preview flex">
            <div class="preview-holder centered">
                ...
                <button v-if="!uploading" @click="deleteImage({ image: form.image, inputId: uploadInputId })" class="image-uploader absolute jc-c ai-c" :class="!(uploading || deleting) ? 'image-uploader-idle' : 'image-uploader-processing'">
        ...
        <form @submit.prevent="" action="" class="flex ai-fe">
            ...
            <div class="flex gap-8">
                ...
                <button @click.prevent="uploadClick(uploadInputId)" data-type="button" class="transparent-button jc-c ai-c">
...
export default {
    ...
    data() {
        return {
            uploading: false,
            deleting: false,
            uploadInputId: 'promptImageUpload',
            form: {
                prompt: '',
                image: null,
                fileType: ''
            ...
            if (!e.shiftKey) {
                ...
                if(this.computedInput) {
                    ...
                    if (this.form.image) {
                        ...
                        this.clrOldfile(this.uploadInputId)
                    }
                    this.$nextTick(() => {
                        this.adjustHeight()
                    })
